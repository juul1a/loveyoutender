...
public class ShipMovement : MonoBehaviour
{
    ...
    //Sets the state to stopped, and updates the animation variable to run the stop animation
    ...
    void MoveLeftRight(){
        ...
        if(transform.position.x > maxX - 20){
            moveRight = false;
            StopForTime(3.0f);
        }
        ...
        else if(transform.position.x < minX + 20){
            moveRight = true;
            StopForTime(3.0f);
        }
    }
